...
class Particle:
    def __init__(self, params):
        ...
        self.pb_position_ = torch.empty(self.nPop, self.nVar)         # particle best position

        # particle best global position
...
class PSO(Particle):
    ...
    def pso_initializer(self):
        ...
        for i in range(self.nPop):
            self.p_cost_[i] = self._fitness.evaluate(self.p_position_[i, :])
